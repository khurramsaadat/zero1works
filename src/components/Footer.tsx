        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <p className="text-gray-400 text-xs">Subscribe to our newsletter for the latest updates and insights.</p>
              <div className="flex space-x-2">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 px-3 py-2 bg-gray-800 border border-gray-700 rounded text-sm text-white placeholder-gray-400 focus:outline-none focus:border-gray-500"
                />
                <button className="px-4 py-2 bg-gray-600 hover:bg-gray-700 rounded text-sm font-medium transition-colors duration-200">
                  Subscribe
                </button>
              </div>
            </div>
            ...
            <div className="flex space-x-4 pt-2">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="text-gray-400 hover:text-white transition-colors duration-200 btn-hover-effect"
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">White Papers</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">Documentation</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200 text-sm">API Reference</a></li>
              </ul>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400">khurram@zerooneworks.com</span>
              </div>
            </div>
          </div>
        </div>
