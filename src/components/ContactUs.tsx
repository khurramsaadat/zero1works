      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <Card className="card-hover-effect">
            <CardHeader>
              <CardTitle className="text-gray-800 dark:text-gray-200">Send us a Message</CardTitle>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-400 focus:border-transparent bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 input-focus-effect"
                    required
                  />
                </div>
          ...
          <div className="space-y-8">
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-gray-800 dark:text-gray-200">9:00 AM - 6:00 PM</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Saturday</span>
                    <span className="text-gray-800 dark:text-gray-200">10:00 AM - 4:00 PM</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600 dark:text-gray-400">Sunday</span>
                    <span className="text-gray-800 dark:text-gray-200">Closed</span>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            {/* Quick Response */}
            <div className="bg-gray-600 dark:bg-gray-700 rounded-lg p-6 text-white">
